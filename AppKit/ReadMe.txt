...
AppWizard a créé cette DLL AppKit pour vous.

Ce fichier contient un résumé des éléments contenus dans chaque fichier qui
constitue votre application AppKit.
...
StdAfx.h, StdAfx.cpp
    ...
    (PCH) nommé AppKit.pch et un fichier de types précompilés 
    nommé StdAfx.obj.
